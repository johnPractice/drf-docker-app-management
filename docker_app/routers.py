...
from docker_app.serializers import CreateContainerizedAppSerializer, RetriveContainerizedAppSerializer, RetriveContainerInfo, InputContainerizedAppSerializer
...
class DockerAppStatusViewset(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        save_container_serializer.save()
        response_serializer = RetriveContainerizedAppSerializer(
            data=save_container_serializer.data)
